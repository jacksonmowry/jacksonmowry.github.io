#include "copy_and_patch_stencils.h"
#include <stddef.h>
#include <stdint.h>
#include <string.h>
...
uint8_t cnp_stencil_add_int1_int2_code[] = {0x45, 0x01, 0xec};
...
uint8_t cnp_stencil_return_int1[] = {0x44, 0x89, 0xe0, 0xc3};
uint8_t *cnp_copy_return_int1(uint8_t *stencil_start) {
    const size_t stencil_size = sizeof(cnp_stencil_return_int1);
    memcpy(stencil_start, cnp_stencil_return_int1, stencil_size);
    return stencil_start + stencil_size;
}
// No patching needed
