...
\title{Homework: Sign and Encrypt}
\hypersetup{
 pdfauthor={Jackson Mowry},
 pdftitle={Homework: Sign and Encrypt},
 pdfkeywords={},
 pdfsubject={},
...
\maketitle
\section*{The Benefits of an Encrypt Then Authenticate Protocol in Secure Communication}
\label{sec:org59449f2}
