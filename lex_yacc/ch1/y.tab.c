...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_simple_sentence = 12,           /* simple_sentence  */
  YYSYMBOL_compound_sentence = 13,         /* compound_sentence  */
  YYSYMBOL_subject = 14,                   /* subject  */
  YYSYMBOL_verb = 15,                      /* verb  */
  YYSYMBOL_object = 16,                    /* object  */
  YYSYMBOL_prep_phrase = 17                /* prep_phrase  */
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* sentence: simple_sentence  */
#line 16 "ch1-05.y"
                           { printf("Parsed a simple sentence.\n"); }
#line 1146 "y.tab.c"
    break;

  case 3: /* sentence: compound_sentence  */
#line 17 "ch1-05.y"
