...
data = np.loadtxt("q6.csv", delimiter=",", dtype=float)
...
plt.xlabel("Mutual Information Splitting Threshold")
plt.ylabel("Accuracy")
plt.title("Sweeping Mutual Information Splitting Threshold")

plt.savefig("q6_graph.jpg")
